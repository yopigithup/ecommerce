                          ...
                          <div class="card">
                              <div class="card-body">
                                  <div class="text-center d-flex flex-column align-items-center">
                                      <img src="{{ !empty($profileData->photo) ? url('upload/admin_images . $proifleData->photo') : url('upload/no_image.jpg') }}"
                              ...
                              <div class="card">
                                  <div class="card-body">
                                      ...
                                      <div class="mb-3 row">
                                          ...
                                          <div class="col-sm-9 text-secondary">
                                              <img id ="showImage"
                                                  src=" {{ !empty($profileData->photo) ? url('upload/admin_images .   $proifleData->photo') : url('upload/no_image.jpg') }}"
