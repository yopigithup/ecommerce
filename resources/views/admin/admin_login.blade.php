...
<body class="">
                                        ...
                                        <form class="row g-3 " method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name = "login"
                                                    ...
                                                    id="login" placeholder="heri@gmail.com">
    ...
    <!--plugins-->
    <script src="{{ asset('backend/assets/js/jquery.min.js') }}assets/js/jquery.min.js"></script>
    <script
        src="{{ asset('backend/assets/plugins/simplebar/js/simplebar.min.js') }}assets/plugins/simplebar/js/simplebar.min.js">
    </script>
